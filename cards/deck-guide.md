...
Every word appears in **both** Spelling and Definitions, so each word is studied in both directions.
...
- **Spelling**, **Synonyms**, **IELTS cloze** and **Pronunciation → Sound-ID** cards are typed: type the answer and press Enter / the Check button.
  ...
  - a *plain* wrong word is never marked right — only accepted answers pass.
